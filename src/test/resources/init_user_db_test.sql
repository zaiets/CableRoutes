...
#set default values
INSERT INTO `cableroutes_test`.`user_profile` (`id`, `role`) VALUES ('1', 'ADMIN');
INSERT INTO `cableroutes_test`.`user_profile` (`id`, `role`) VALUES ('2', 'USER');

#login = admin, password = abc125
INSERT INTO `cableroutes_test`.`users`
